  ...
  */
   ...
   */
   public static void main( String args[] ) {
      ...
      timeSlice = 11;
      while ( clock.getTotalSeconds() <= SECONDS_IN_TWELVE_HOURS ) {
        System.out.println("Minute hand angle is at " + clock.getMinuteHandAngle() );
        System.out.println("Hour hand angle is at " + clock.getHourHandAngle() );
        System.out.println("The time is: " + clock.toString() );
        System.out.println("Angle between is" + clock.getHandAngle() );
        clock.tick();
        System.out.println( "\n" );
      }
      ...
      System.out.println("1800 seconds should be 1800: " + clock.validateTimeSliceArg( "1800" ));
      //regular numbers
      System.out.println("85 seconds should be 61: " + clock.validateTimeSliceArg("85"));
      System.out.println("2 second should be 2: " + clock.validateTimeSliceArg("2"));
      //a decinmal
      System.out.println("0.321 seconds should be 0.00001: " + clock.validateTimeSliceArg("0.123"));
      //none at all
      System.out.println("No seconds should be 60: " + clock.validateTimeSliceArg("60"));
      System.out.println("\n");
      ...
      try { clock.validateEpsilonArg("3.1"); }
